  ...
  return (
    <header className="py-4 px-4 sm:px-10 z-50 min-h-[70px]">
      <div className="relative flex flex-wrap items-center gap-4">
        <a className="inline" href="javascript:void(0)">
          <img
            src={Logo}
            alt="logo"
            className="w-10 inline-block"
          />
          <span className="font-bold">GrantGenie</span>
        </a>
        ...
        <div className="flex ml-auto">
          <button onClick={() => navigate("/login")} className="px-10 py-2 rounded-md text-white bg-primary transition-all hover:bg-primary/80">
            Login
          </button>
