...
import Image from '@/assets/Investor Presentation Meeting.jpeg';
    ...
    <div className="px-4 sm:px-10">
      <div className="mt-20 max-w-7xl mx-auto">
        <div className="mb-16 max-w-2xl text-center mx-auto">
          ...
          <p className="mt-6">
            At GrantGenie, we understand the challenges of navigating complex
            application processes and finding the right opportunities.
          </p>
        </div>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          <div className="sm:p-6 p-4 flex bg-white rounded-md border shadow-[0_14px_40px_-11px_rgba(93,96,127,0.2)]">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">
                Automating Grant and Proposal Writing
              </h3>
              <p>
                Save time and resources with AI-driven tools that prepare
                professional-grade documents, aligning perfectly with specific
                requirements.
              </p>
            </div>
          </div>
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            ...
            <div>
              ...
              <p>
                Our solutions combine AI optimization with expert review and
                personalized planning to maximize your chances of success.
              </p>
            </div>
          </div>
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            ...
            <div>
              ...
              <p>
                Whether you're eyeing opportunities from NSF or other agencies,
                GrantGenie provides access to a wide range of funding options.
              </p>
            </div>
          </div>
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            ...
            <div>
              ...
              <p>
                Designed to suit businesses at every stage, our scalable pricing
                tiers ensure you get the support you need without overextending
                your budget.
              </p>
            </div>
          </div>
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            ...
            <div>
              ...
              <p>
                Personalized recommendations help identify the best funding
                opportunities for your specific goals
              </p>
            </div>
          </div>
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            ...
            <div>
              ...
              <p>
                Team-friendly features make it easy to collaborate with
                stakeholders and finalize applications efficiently.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-2 justify-center items-center gap-10 max-w-7xl mx-auto">
        <div className="max-md:text-center">
          ...
          <button
            ...
            className="px-6 py-3 rounded-md text-white bg-primary transition-all hover:bg-primary/80 mt-10"
          >
            Try it today
          </button>
        </div>
